...
function stickColor(squaresTile){
     const getttingColor = greenColors2();
    squaresTile.style.backgroundColor = getttingColor;
    squaresTile.style.boxshadow = `0 0 2px ${getttingColor}, 0 0 10px ${getttingColor}`;
}


function addColor(squaresTile) {
    const getttingColor = greenColors();
    squaresTile.style.backgroundColor = getttingColor;
    squaresTile.style.boxshadow = `0 0 2px ${getttingColor}, 0 0 10px ${getttingColor}`;
}
